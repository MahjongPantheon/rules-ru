...
\newtcolorbox{example}[2][]{before skip=\baselineskip,breakable,colback=yellow!5!white,colframe=yellow!75!black,colbacktitle=yellow!10!white,coltitle=yellow!20!black,title=\centering{Пример}}
...
\author{Oleg Klimenko, Kirill Khromov, Annifrid Yumetsuki, Denis Alexandrov}
\title{Риичи-маджонг: правила и регламенты / Руководство по проведению турниров}
...
\begin{document}
	...
	\begin{center}
		...
		\normalsize
		Руководство по проведению турниров\par
		\vspace{5cm}
		\includegraphics[width=5cm]{logo}
		\vfill
		Версия 1.4 от 19 апреля 2026 г.
	\end{center}
	\newpage
	...
	% Основной контент
	\input{./chapters/tournaments.tex}
